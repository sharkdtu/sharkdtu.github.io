...
![spark-on-yarn-distribution-framework](./spark-distribution-framework.png)
...
![spark-submit-time](./spark-submit-time.png)
...
![Alt text](./spark-scheduler-overview.png)
...
![Alt text](./spark-scheduler-detail.png)
...
![Alt text](./spark-scheduler-dag-process.png)
...
![Alt text](./spark-scheduler-dag-wordcount.png)
...
![Alt text](./spark-scheduler-task-process.png)
...
![Alt text](./spark-scheduler-pool.png)
...
![Alt text](./spark-scheduler-fifo-tree.png)
...
![Alt text](./spark-scheduler-fair-tree.png)
...
![Alt text](./spark-scheduler-taskset-process.png)
...
![Alt text](./spark-scheduler-task-locatity-process.png)
...
![Alt text](./spark-scheduler-speculation-process.png)

检查是否有Task需要推测执行的逻辑最后会交到TaskSetManager，TaskSetManager采用基于统计的算法，检查Task是否需要推测执行，算法流程大致如下图所示。

![Alt text](./spark-scheduler-speculation-check.png)
...
![Alt text](./spark-scheduler-resource.png)
