...
<img src="/images/spark-distribution-framework.png" width="600" height="430" alt="spark-on-yarn-distribution-framework" align=center />
...
<img src="/images/spark-submit-time.png" width="600" height="430" alt="spark-submit-time" align=center />
...
<img src="/images/spark-scheduler-overview.png" width="600" height="430" alt="spark-scheduler-overview" align=center />
...
<img src="/images/spark-scheduler-detail.png" width="600" height="430" alt="spark-scheduler-detail" align=center />
...
<img src="/images/spark-scheduler-dag-process.png" width="600" height="430" alt="spark-scheduler-dag-process" align=center />
...
<img src="/images/spark-scheduler-dag-wordcount.png" width="600" height="430" alt="spark-scheduler-dag-wordcount" align=center />
...
<img src="/images/spark-scheduler-task-process.png" width="600" height="430" alt="spark-scheduler-task-process" align=center />
...
<img src="/images/spark-scheduler-pool.png" width="600" height="430" alt="spark-scheduler-pool" align=center />
...
<img src="/images/spark-scheduler-fifo-tree.png" width="600" height="430" alt="spark-scheduler-fifo-tree" align=center />
...
<img src="/images/spark-scheduler-fair-tree.png" width="600" height="430" alt="spark-scheduler-fair-tree" align=center />
...
<img src="/images/spark-scheduler-taskset-process.png" width="600" height="430" alt="spark-scheduler-taskset-process" align=center />
...
<img src="/images/spark-scheduler-task-locatity-process.png" width="600" height="430" alt="spark-scheduler-task-locatity-process" align=center />
...
<img src="/images/spark-scheduler-speculation-process.png" width="600" height="430" alt="spark-scheduler-speculation-process" align=center />

检查是否有Task需要推测执行的逻辑最后会交到TaskSetManager，TaskSetManager采用基于统计的算法，检查Task是否需要推测执行，算法流程大致如下图所示。

<img src="/images/spark-scheduler-speculation-check.png" width="600" height="430" alt="spark-scheduler-speculation-check" align=center />
...
<img src="/images/spark-scheduler-resource.png" width="600" height="430" alt="spark-scheduler-resource" align=center />
